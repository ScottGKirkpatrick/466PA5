...
if __name__ == '__main__':
    ...
    #Format { dst : [hop1,...,hopn]}
    encap_tbl_D = {'H1': [], 'H2': ['RB'] }    # table used to encapsulate network packets into MPLS frames
    #Format {dst : int}
    frwd_tbl_D = {'H1': 0, 'RB': 1}     # table used to forward MPLS frames
